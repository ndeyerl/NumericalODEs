/* Trapezoidal time stepper class implementation file.

   Class to perform time evolution of the IVP
        y' = f(t,y),  t in [t0, Tf],  y(t0) = y0
   using the trapezoidal (Crank-Nicolson) time stepping method. 
...
TrapezoidalStepper::TrapezoidalStepper(RHSFunction& frhs_, RHSJacobian& Jrhs_, 
                                       std::vector<double>& y) {
